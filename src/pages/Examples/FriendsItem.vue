<!--
 * @Author: Lee
 * @Date: 2023-03-06 20:03:37
 * @LastEditors: Lee
 * @LastEditTime: 2023-03-06 20:03:57
 * @Description: 
-->
<script setup lang="ts">
// -- props
const props = withDefaults(defineProps<{ data?: API.FriendsItemProps }>(), {
  data: () => ({} as API.FriendsItemProps),
});
</script>
...
<template>
  <div class="friends-item px-10 mt-10">
    <div
      class="wrap d-flex justify-content-between align-items-center bg-FFFFFF py-12 px-10 rounded-6"
    >
